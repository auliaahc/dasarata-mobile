...
import 'package:dasarata_mobile/screens/customer/closing/home_point/home_point_closing_customer_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppbarGlobalWidget(
        ...
        onPressedAction: () => Get.to(const HomePointClosingCustomerScreen()),
      ),
      body: Obx(
        () {
